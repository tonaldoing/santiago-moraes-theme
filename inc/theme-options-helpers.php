...
function sm_maybe_migrate_customizer_to_options() {
	...
	$keys_defaults = array(
		...
		'sm_color_footer_bg'         => '#FFFFFF',
		'sm_color_footer_text'       => '#9A5F4C',
...
function sm_customizer_css() {
	$vars = array(
		...
		'--color-footer-bg'         => sm_get_option( 'sm_color_footer_bg', '#FFFFFF' ),
		'--color-footer-text'       => sm_get_option( 'sm_color_footer_text', '#9A5F4C' ),
