<?php
/**
 * Homepage — Contacto section.
 *
 * Dark bg with inline email + message form and social icons.
 * Reuses the same AJAX handler from inc/contact-form.php.
 *
...
$home_social = array(
	'instagram'  => array(
		'url'   => sm_get_option( 'sm_social_instagram', '' ),
		'label' => 'Instagram',
	...
	'spotify'    => array(
		'url'   => sm_get_option( 'sm_social_spotify', '' ),
		'label' => 'Spotify',
	...
	'youtube'    => array(
		'url'   => sm_get_option( 'sm_social_youtube', '' ),
		'label' => 'YouTube',
	...
	'bandcamp'   => array(
		'url'   => sm_get_option( 'sm_social_bandcamp', '' ),
		'label' => 'Bandcamp',
	...
	'facebook'   => array(
		'url'   => sm_get_option( 'sm_social_facebook', '' ),
		'label' => 'Facebook',
	...
	'twitter'    => array(
		'url'   => sm_get_option( 'sm_social_twitter', '' ),
		'label' => 'Twitter/X',
...
$active_social = array_filter( $home_social, function ( $data ) {
...
<section class="home-contact" id="contacto">
	<div class="home-contact__inner">
		...
		<form class="home-contact__form" id="sm-home-contact-form" method="post">
			...
			<?php // Hidden name — uses email prefix as name for this compact form. ?>
			...
			<div class="home-contact__fields">
				...
				<input
					...
					required
				>
				<button type="submit" class="btn btn--primary btn--sm" id="sm-home-contact-submit">
		...
		<?php if ( $active_social ) : ?>
			<div class="home-contact__social">
				<?php foreach ( $active_social as $network => $data ) : ?>
