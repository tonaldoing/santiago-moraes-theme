<?php
/**
 * Render: sm/social-links
 *
 * Standalone social icon row — reads URLs from Customizer.
 *
...
$wrapper_classes = array(
	'sm-social-links',
	'sm-social-links--' . $size,
	'sm-social-links--' . $alignment,
);

$anchor = ! empty( $attributes['anchor'] ) ? ' id="' . esc_attr( $attributes['anchor'] ) . '"' : '';
?>

<div class="<?php echo esc_attr( implode( ' ', $wrapper_classes ) ); ?>"<?php echo $anchor; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	<?php foreach ( $active_social as $data ) : ?>
		<a href="<?php echo esc_url( $data['url'] ); ?>" class="sm-social-links__link" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( $data['label'] ); ?>">
