<?php
/**
 * Render: sm/upcoming-shows
 *
 * Dynamic block — queries upcoming evento CPT posts.
 * Reuses .shows / .show-card BEM classes.
 *
...
<section class="shows"<?php echo $anchor; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
